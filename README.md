...
This extension is provided under the [MIT License](LICENSE.md).
...
This Nova extension let’s you connect to any inference provider with OpenAI compatible API endpoints (`/models`, `/chat/completions`) (local or remote). The extension was heavily tested using [**Osaurus**](https://osaurus.ai) running on an iMac.

#### Credit where credit is due

Kudos to [Akira Yamanashi (CCLite)](https://extensions.panic.com/extensions/co.partavocado/co.partavocado.CCLite/) for the **brilliant idea** how to “misuse” Nova’s sidebar as a chat UI. It’s been a great inspiration ;)